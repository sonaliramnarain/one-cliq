class AttendancesController < ApplicationController
  ...
  def destroy
    ...
    if @attendance.destroy
      ...
      redirect_to check_agenda_students_path(@attendance.agenda, anchor: "student-#{student.id}"), notice: "Message sent to #{student.parent.name}: 'Your child is missing from school!👮' "
    end
  end
 private
